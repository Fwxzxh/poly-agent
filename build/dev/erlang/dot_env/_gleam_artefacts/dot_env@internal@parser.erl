...
-define(FILEPATH, "src/dot_env/internal/parser.gleam").
-export([parse/1]).
...
-file("src/dot_env/internal/parser.gleam", 109).
?DOC(false).
-spec parse_comment(list(binary()), fun((list(binary())) -> DZS)) -> DZS.
...
-file("src/dot_env/internal/parser.gleam", 117).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 39).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 59).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 71).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 84).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 96).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 47).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 33).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 20).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 124).
?DOC(false).
...
-file("src/dot_env/internal/parser.gleam", 14).
?DOC(false).
